...
public class PersonasWebService {
    ...
    public void save(@WebParam(name = "persona") PersonasDTO persona){
    ...
    public void update(@WebParam(name = "persona") PersonasDTO persona, @WebParam(name = "idPersona")Long idPersona){
